...
import static edu.kh.todoList.common.JDBCTemplate.*; // static과 뒤에 .* 을 쓰는 것으로 커넥션 생성처럼 JDBCTemplate.메서드 형식으로 쓰지 않고 단축해도 된다.
...
public class TodoListServiceImpl implements TodoListService{
	...
	public Map<String, Object> todoListFullView() throws Exception {
		...
		// -> 메서드에서 반환은 하나의 값 또는 객체밖에 할 수 없기 때믄
	...
	public int todoAdd(String title, String detail) throws Exception {
		...
		// DML 중 INSERT를 했으므로 트랜잭션 제어처리 필요
